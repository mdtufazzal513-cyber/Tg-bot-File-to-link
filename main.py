...
def generate_link(user_id, views, expire_hours, chat_id, title="Untitled"):
    ...
    if db_channel_check and file_storage[unique_id]['files'][0].get('db_msg_id'):
        msg_text += "🌐 <b>ডিরেক্ট ওয়েব লিংকসমূহ:</b>\n\n"
...
async def stream_handler(request):
    try:
        ...
        # 🚀 Advanced Streaming Headers: ব্রাউজারকে বাফারিং কমাতে এবং কানেকশন ধরে রাখতে ফোর্স করা
        headers = {
            'Content-Type': mime_type,
            'Accept-Ranges': 'bytes',
            'Content-Disposition': f"{disp}; filename*=UTF-8''{quote(file_name)}",
            'Cache-Control': 'public, max-age=86400', # ব্রাউজারকে ভিডিও মেমোরিতে সেভ রাখতে বলবে
            'Connection': 'keep-alive', # কানেকশন কাটতে দিবে না
            'Access-Control-Allow-Origin': '*' # যেকোনো ব্রাউজার/প্লেয়ার থেকে অ্যাক্সেস দিবে
        }
