...
def update_setting(message, key, val_type):
    # ইউজারের ইনপুট এবং বটের প্রশ্ন ডিলিট করা
    try:
    ...
    if not message.text: return bot.send_message(message.chat.id, "❌ টেক্সট ইনপুট দিন!")
...
def process_limit_input(message, user_id, limit_type):
    ...
    if not message.text: return bot.send_message(message.chat.id, "❌ সঠিক সংখ্যা দিন!")
    try:
...
def generate_link(user_id, views, expire_hours, chat_id, title="Untitled"):
    # টাইটেল ইনপুট মেসেজ ডিলিট করার চেষ্টা
    # আমরা জানি এই ফাংশনটি টাইটেল দেওয়ার পর কল হয়, তাই শেষ মেসেজটি ডিলিট করা নিরাপদ
    ...
    try:
        ...
        async def upload_task():
            try:
                ...
                # আইডিটি ক্লিন করে ইনটিজারে রূপান্তর
